...
public class RTSCameraController : MonoBehaviour
{
    ...
    [SerializeField] 
    bool moveWithEdgeScrolling;
    [SerializeField] 
    bool moveWithMouseDrag;
    ...
    [SerializeField] 
    float movementSensitivity = 1f; // Hardcoded Sensitivity
    float movementSpeed;
    ...
    private void Zoom(float aZoomSpeed)
    {
        Camera.main.fieldOfView += aZoomSpeed * Time.deltaTime;
    }
    private void Rotate(float aRotationDirection)
    {
        transform.Rotate(0, aRotationDirection * Time.deltaTime, 0);
    }
